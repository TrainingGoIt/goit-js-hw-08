...
const images = (0, _galleryItems.galleryItems).map(({ preview , original , description  })=>`<a class="gallery__item" href="${original}">
  <img class="gallery__image" src="${preview}" alt="${description}" title="${description}" />
</a>`).join("");
galleryArr.insertAdjacentHTML("beforeend", images);
let gallery = new (0, _simpleLightboxEsmDefault.default)(".gallery a", {
    fadeSpeed: 250
});
gallery.on("show.simplelightbox", function() {});

},{"simplelightbox/dist/simple-lightbox.esm":"chDZx","./gallery-items":"9C7dK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"chDZx":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["b4hXe","6XVkV"], "6XVkV", "parcelRequire4c75")
